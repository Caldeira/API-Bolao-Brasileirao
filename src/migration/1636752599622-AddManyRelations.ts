...
export class AddManyRelations1636752599622 implements MigrationInterface {
    name = 'AddManyRelations1636752599622'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`rodada\` ADD \`campeonatoId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`partida\` ADD \`rodadaId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`aposta\` ADD \`partidaId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`endereco\` CHANGE \`usuarioId\` \`usuarioId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`slug\` \`slug\` varchar(50) NULL`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`nomePopular\` \`nomePopular\` varchar(50) NULL`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`logo\` \`logo\` varchar(500) NULL`);
        await queryRunner.query(`ALTER TABLE \`rodada\` CHANGE \`nome\` \`nome\` varchar(50) NULL`);
        await queryRunner.query(`ALTER TABLE \`rodada\` CHANGE \`slug\` \`slug\` varchar(50) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`rodada\` CHANGE \`slug\` \`slug\` varchar(50) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`rodada\` CHANGE \`nome\` \`nome\` varchar(50) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`logo\` \`logo\` varchar(500) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`nomePopular\` \`nomePopular\` varchar(50) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`slug\` \`slug\` varchar(50) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`endereco\` CHANGE \`usuarioId\` \`usuarioId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`aposta\` DROP COLUMN \`partidaId\``);
        await queryRunner.query(`ALTER TABLE \`partida\` DROP COLUMN \`rodadaId\``);
        ...
        await queryRunner.query(`ALTER TABLE \`rodada\` DROP COLUMN \`campeonatoId\``);
